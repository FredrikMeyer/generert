...
(deftest intersect-circle-test
  (is (= true
         (s/pt-intersect-circle (s/point 0 0) (s/->Circle (s/point [0 0]) 1))))
  (is (= false
         (s/pt-intersect-circle (s/point 0 0) (s/->Circle (s/point [1 1]) 0.5))))
  (is (= true
         (s/pt-intersect-circle  (s/point 2 2) (s/->Circle (s/point [0 0]) 3))))
  (is (= true
         (s/pt-intersect-circle (s/point  2 2) (s/->Circle (s/point [0 0]) 5)))))
